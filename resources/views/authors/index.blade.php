    ...
    <div class="container d-flex justify-content-center align-items-center" style="height: 300px">
        <div class="col-6 text-center">
            <form method="" action="" enctype="">
                ...
                <input id="file" name="file" type="file" class="filepond @error('file') is-invalid @enderror">
                @error('file')
                        ...
                        <tr>
                            <td>
                                <div class="text-center flex-column">
                                    <div>
                                        <h6 class="mb-0 text-sm">{{ $files->first_name }}</h6>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="text-center flex-column">
                                    <h6 class="mb-0 text-sm">{{ $files->last_name }}</h6>
                                </div>
                            </td>
                            <td>
                                <div class="text-center flex-column">
                                    <h6 class="mb-0 text-sm">{{ $files->date_of_birth }}</h6>
                                </div>
                            </td>
                            <td>
                                <div class="text-center flex-column">
                                    <h6 class="mb-0 text-sm">{{ $files->date_of_death }}</h6>
                                </div>
                            </td>
                            <td>
                                <div class="text-center flex-column">
                                    <h6 class="mb-0 text-sm">{{ $files->book }}</h6>
                                </div>
                            </td>
                            <td>
                                <div class="text-center flex-column">
                                    <h6 class="mb-0 text-sm">{{ $files->nobel_prize }}</h6>
                                </div>
                            </td>
                        </tr>
                    @endforeach
